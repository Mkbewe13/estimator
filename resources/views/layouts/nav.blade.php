<nav class="navbar navbar-expand-lg navbar-light bg-indigo-50 py-3">
    ...
    <div class="navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item ml-md-5 {{ Request::is('/') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('index') }}">Projects Estimations</a>
            </li>
            <li class="nav-item ml-md-3 {{ Request::is('estimations*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('estimations.form') }}">Create Estimation</a>
            </li>
        </ul>
    </div>
</nav>
